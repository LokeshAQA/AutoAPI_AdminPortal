...
public class AM_RuleType_PUT_with_distinct_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Update_RuleType(String url) throws IOException, InterruptedException {
		try {
			sheetname = "RuleType_Update";
