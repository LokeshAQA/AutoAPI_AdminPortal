...
public class ADDIN_GET_with_distinct_GetAllVersionByNameAndRegion extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_Addin(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Addin_View";
