...
public class Addin_Config_PUT_with_StartVersionChange_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Update_AddinConfig(String url) throws IOException, InterruptedException {
		try {
			sheetname = "AddinConfig_Update";
