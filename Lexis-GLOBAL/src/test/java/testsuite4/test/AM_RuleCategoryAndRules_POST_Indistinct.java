...
public class AM_RuleCategoryAndRules_POST_Indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_RuleCategory(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Rulecategory_Create";
