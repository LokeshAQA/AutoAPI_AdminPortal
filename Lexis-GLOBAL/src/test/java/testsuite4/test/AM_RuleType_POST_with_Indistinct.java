...
public class AM_RuleType_POST_with_Indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_RuleType(String url) throws IOException, InterruptedException {
		try {
			sheetname = "RuleType_Create";
