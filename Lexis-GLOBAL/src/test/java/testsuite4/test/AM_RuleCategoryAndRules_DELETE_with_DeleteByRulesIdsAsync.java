...
public class AM_RuleCategoryAndRules_DELETE_with_DeleteByRulesIdsAsync extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Delete_RuleCategory(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Rulecategory_Delete";
