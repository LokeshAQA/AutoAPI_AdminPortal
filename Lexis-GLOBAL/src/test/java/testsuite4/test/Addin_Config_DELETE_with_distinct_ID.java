...
public class Addin_Config_DELETE_with_distinct_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Delete_AddinConfig(String url) throws IOException, InterruptedException {
		try {
			sheetname = "AddinConfig_Delete";
