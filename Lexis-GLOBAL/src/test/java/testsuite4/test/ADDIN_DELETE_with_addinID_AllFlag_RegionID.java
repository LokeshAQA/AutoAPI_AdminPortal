...
public class ADDIN_DELETE_with_addinID_AllFlag_RegionID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Delete_Addin(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Addin_Delete";
