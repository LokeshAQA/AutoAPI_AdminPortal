...
public class Rule_Config_PUT_with_distinct_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Update_RuleConfig(String url) throws IOException, InterruptedException {
		try {
