...
public class RuleExpression_GET_TagValidation_Tag extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void ViewSpecific_RuleExpression_TagValidation_Tag(String url) throws IOException, InterruptedException {
		try {
