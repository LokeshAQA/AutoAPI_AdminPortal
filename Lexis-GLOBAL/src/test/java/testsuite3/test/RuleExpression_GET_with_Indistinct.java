...
public class RuleExpression_GET_with_Indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_RuleExpression(String url) throws IOException, InterruptedException {
		try {
