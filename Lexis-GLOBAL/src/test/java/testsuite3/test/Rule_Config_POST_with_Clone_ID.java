...
public class Rule_Config_POST_with_Clone_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_RuleConfig_Clone(String url) throws IOException, InterruptedException {
		try {
