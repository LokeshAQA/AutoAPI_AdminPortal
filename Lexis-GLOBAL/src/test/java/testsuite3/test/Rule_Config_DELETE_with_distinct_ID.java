...
public class Rule_Config_DELETE_with_distinct_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Delete_RuleConfig(String url) throws IOException, InterruptedException {
		try {
