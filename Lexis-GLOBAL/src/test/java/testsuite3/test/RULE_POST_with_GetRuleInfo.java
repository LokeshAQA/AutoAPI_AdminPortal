...
public class RULE_POST_with_GetRuleInfo extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_Rule_GetRuleInfo(String url) throws IOException, InterruptedException {
		try {
