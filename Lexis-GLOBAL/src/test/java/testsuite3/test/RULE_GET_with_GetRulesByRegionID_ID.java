...
public class RULE_GET_with_GetRulesByRegionID_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void ViewSpecific_ID_GetRulesByRegionID_ID(String url) throws IOException, InterruptedException {
		try {
