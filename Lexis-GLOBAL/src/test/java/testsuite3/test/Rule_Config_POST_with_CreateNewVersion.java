...
public class Rule_Config_POST_with_CreateNewVersion extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_RuleConfig_CreateNewVersion(String url) throws IOException, InterruptedException {
		try {
