...
public class Rule_Config_POST_with_Indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_RuleConfig(String url) throws IOException, InterruptedException {
		try {
