...
public class RuleExpression_GET_GetAllByRuleConfiguration_ID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void ViewSpecific_RuleExpression_GetAllByRuleConfiguration_ID(String url) throws IOException, InterruptedException {
		try {
