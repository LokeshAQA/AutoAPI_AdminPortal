...
public class Jurisdiction_DELETE_with_distinct_JurisdictionID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_Specific_Jurisdiction_using_ID(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Jurisdiction_Delete";
