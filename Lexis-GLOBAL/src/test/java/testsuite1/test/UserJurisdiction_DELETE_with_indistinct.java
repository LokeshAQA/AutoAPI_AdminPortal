...
public class UserJurisdiction_DELETE_with_indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Delete_UserJurisdiction(String url) throws IOException, InterruptedException {
		try {
			sheetname = "UserJurisdiction_Delete";
