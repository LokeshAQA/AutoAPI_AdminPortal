...
public class Region_DELETE_Delete extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void DELETE_Specific_Region_using_ID(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Region_Delete";
