...
public class UserJurisdiction_GET_with_distinct_UserID_JurisdictionID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_Specific_UserJurisdiction_using_UserID_JurisID(String url) throws IOException, InterruptedException {
		try {
			sheetname = "UserJurisdiction_View(ID)";
