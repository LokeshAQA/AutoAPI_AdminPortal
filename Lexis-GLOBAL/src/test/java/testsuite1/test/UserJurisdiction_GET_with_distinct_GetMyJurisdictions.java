...
public class UserJurisdiction_GET_with_distinct_GetMyJurisdictions extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_Specific_UserJurisdiction_using_GetMyJurisdictions(String url) throws IOException, InterruptedException {
		try {
			sheetname = "UserJurisdiction_View";
