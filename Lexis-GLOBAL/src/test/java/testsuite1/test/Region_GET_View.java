...
public class Region_GET_View extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void VIEW_All_Region(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Region_View";
