...
public class Jurisdiction_GET_with_indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_All_Jurisdiction(String url) throws IOException, InterruptedException {
		try {
