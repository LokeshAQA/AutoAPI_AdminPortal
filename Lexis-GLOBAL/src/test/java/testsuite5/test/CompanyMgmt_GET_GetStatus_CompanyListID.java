...
public class CompanyMgmt_GET_GetStatus_CompanyListID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_CompanyMgmt(String url) throws IOException, InterruptedException {
		try {
