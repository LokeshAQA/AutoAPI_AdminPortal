...
public class CompanyMgmt_POST_with_UploadCompanyInfo extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_CompanyMgmt(String url) throws IOException, InterruptedException {
		try {
			sheetname = "CompanyMgmt_Create";
