...
public class EntityType_GET_with_indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_EntityType(String url) throws IOException, InterruptedException {
		try {
			sheetname = "EntityType_View";
