...
public class EntitySubType_GET_with_indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_EntitySubType(String url) throws IOException, InterruptedException {
		try {
			sheetname = "EntitySubType_View";
