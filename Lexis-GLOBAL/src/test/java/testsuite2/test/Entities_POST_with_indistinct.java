...
public class Entities_POST_with_indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Create_Entities(String url) throws IOException, InterruptedException {
		try {
			sheetname = "Entities_Create";
