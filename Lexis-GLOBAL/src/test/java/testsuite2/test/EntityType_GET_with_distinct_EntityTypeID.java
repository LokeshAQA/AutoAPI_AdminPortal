...
public class EntityType_GET_with_distinct_EntityTypeID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void View_Specific_EntityType_using_EntityTypeID(String url) throws IOException, InterruptedException {
		try {
			sheetname = "EntityType_View(ID)";
