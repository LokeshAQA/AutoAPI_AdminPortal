...
public class EntityType_PUT_with_indistinct extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Update_EntityType(String url) throws IOException, InterruptedException {
		try {
			sheetname = "EntityType_Update";
