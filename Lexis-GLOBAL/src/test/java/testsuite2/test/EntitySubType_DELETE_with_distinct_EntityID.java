...
public class EntitySubType_DELETE_with_distinct_EntityID extends Environment {

	@Test(dataProvider = "ProbaseURL", dataProviderClass = DP_Base.class)
	public static void Delete_EntitySubType_using_EntityID(String url) throws IOException, InterruptedException {
		try {
			sheetname = "EntitySubType_Delete";
